 ...
 * configured for a given {@link vaultiq.session.cache.model.ModelType}. It is often used
 ...
 * @see vaultiq.session.cache.model.ModelType Defines the different types of session data models.
