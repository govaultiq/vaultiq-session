...
public class VaultiqPersistenceCondition implements Condition {
    private static final Logger log = LoggerFactory.getLogger(VaultiqPersistenceCondition.class);
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        Object modeObj = attributes.getFirst("value");
        ...
        log.debug("Evaluating VaultiqPersistenceCondition with mode={}, jpa={}, cache={}", mode, jpa, cache);
